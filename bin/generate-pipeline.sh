...
echo -e "${cyan_color}===================================================================================${no_color}"
echo -e "${cyan_color}Shared pipeline project name: ${shared_pipeline_project}${no_color}"
echo -e "${cyan_color} Shared pipeline project dir: ${shared_pipeline_project_dir}${no_color}"
echo -e "${cyan_color} Shared pipeline config file: ${shared_pipeline_config_file}${no_color}"
echo -e "${cyan_color} Shared pipeline params file: ${shared_pipeline_parameters_file}${no_color}"
...
echo -e "${cyan_color}Project pipeline params file: ${project_pipeline_parameters_file}${no_color}"
echo -e "${cyan_color}               Pipeline name: ${pipeline_name}${no_color}"
echo -e "${cyan_color}        Pipeline config file: ${generated_pipeline_config_file}${no_color}"
echo -e "${cyan_color}        Pipeline params file: ${generated_pipeline_parameters_file}${no_color}"
echo -e "${cyan_color}      Concourse CI team name: ${concourse_team_name}${no_color}"
echo -e "${cyan_color}       Concourse CI username: ${concourse_username}${no_color}"
echo -e "${cyan_color}       Concourse CI password: $(mask_string ${concourse_password})${no_color}"
echo -e "${cyan_color}===================================================================================${no_color}"
echo ""
